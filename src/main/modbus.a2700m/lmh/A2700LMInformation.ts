...
export default class A2750LMInformationReg extends RegisterBase {
    ...
    getter = (): Observable<A2700Data>  => ModbusService.read(61500, 11).pipe(
        map((data) => {
          ...
          result.applicationVersion = LMInformation.getAppVersion(applicationVersion);
          result.bootloaderVersion = LMInformation.getAppVersion(bootloaderVersion);;
