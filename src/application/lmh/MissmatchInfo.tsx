...
export default function MissmatchInfo(): ReactElement {
    ...
    usePolling('POLL-MISSMATCH-STATE', (evt, resp) => {
        const missMatchStatus = resp as LMMissmatchState;
    ...
    return (
        <Space size="small" style={{backgroundColor: "#fc6e5c", padding: "20px"}}>
            <p style={{fontSize: "15px", fontWeight: 600}}>{alarm ? "Missmatch":"No missmatch"}</p>
